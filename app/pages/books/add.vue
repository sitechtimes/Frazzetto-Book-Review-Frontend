        ...
        <section class="max-w-6xl mx-auto px-10 py-14">
            ...
            <div class="grid grid-cols-[280px_1fr] gap-16">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <label class="mt-8 cursor-pointer text-lg underline hover:text-gray-600">
                        Upload Book Cover
                ...
                <div class="space-y-7">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-4 gap-y-4 gap-x-8">
                            ...
                            <label v-for="genre in genres" :key="genre" class="flex items-center gap-3 text-sm">

                                <input type="checkbox" class="checkbox checkbox-sm border-gray-300" :value="genre"
                                    v-model="book.genre" />
                    ...
                    <div class="flex justify-center gap-6 pt-16">
                        ...
                        <RouterLink to="/explore" class="btn bg-white border border-gray-300 text-gray-800 px-10">
                            Cancel
                        </RouterLink>


                        <button class="btn bg-slate-800 text-white px-10 hover:bg-slate-900" @click="submitBook">
                            Submit Book
                        </button>
