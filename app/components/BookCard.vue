<template>
    <div class="group flex flex-col transition-transform duration-200 hover:-translate-y-1">
        ...
        <div class="mt-4 space-y-2">
            ...
            <RouterLink :to="`/books/${book.id}`" class="font-semibold text-base leading-tight hover:underline">
                {{ book.title }}
            </RouterLink>
            ...
            <div class="flex flex-wrap gap-1">
                <span v-for="genre in book.genre" :key="genre" class="text-xs text-gray-500">
                    {{ genre }}
                    <span v-if="genre !== book.genre[book.genre.length - 1]">
                        •
                    </span>
                </span>
            </div>
            ...
            <p class="text-sm text-gray-700 leading-relaxed">
                ...
                <RouterLink :to="`/books/${book.id}`" class="font-medium underline">
                    Read More
                </RouterLink>
            </p>
            ...
            <div class="flex items-center gap-2 pt-1">
                ...
                <div class="flex">
                    <span v-for="(percentage, index) in stars" :key="index"
                        ...
                        <span class="absolute left-0 top-0 overflow-hidden text-black"
